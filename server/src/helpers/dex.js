...
const StrmToken = '0x0000000000000000000000000000000000000001'
    ...
    formatOrder: async (orders) => {
        ...
        for (let i = 0; i < orders.length; i++) {
            ...
            if (!Object.prototype.hasOwnProperty.call(decimals, bt)) {
                if (bt === StrmToken) {
                    decimals[bt] = { decimals: 18, symbol: 'STRM' }
                } else {
            ...
            if (!Object.prototype.hasOwnProperty.call(decimals, qt)) {
                if (qt === StrmToken) {
                    decimals[qt] = { decimals: 18, symbol: 'STRM' }
                } else {
    ...
    formatLendingOrder: async (orders) => {
        ...
        for (let i = 0; i < orders.length; i++) {
            ...
            if (!Object.prototype.hasOwnProperty.call(decimals, lt)) {
                if (lt === StrmToken) {
                    decimals[lt] = { decimals: 18, symbol: 'STRM' }
                } else {
            ...
            if (!Object.prototype.hasOwnProperty.call(decimals, ct)) {
                if (ct === StrmToken) {
                    decimals[ct] = { decimals: 18, symbol: 'STRM' }
                } else {
