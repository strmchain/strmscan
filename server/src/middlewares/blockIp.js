    ...
    return async function (req, res, next) {
        ...
        if (ip && ip !== '::1' && ip !== '127.0.0.1') {
            ...
            if (!cache5min) {
                ...
                const url5min = `https://graylog.strmchain.com/api/search/universal/relative?query=message%3A${ip}&range=300&limit=1&fields=message&sort=desc&decorate=true&filter=streams%3A5bd804ebf13e3300018780df`
            ...
            if (!cache1day) {
                // eslint-disable-next-line
                const url1day = `https://graylog.strmchain.com/api/search/universal/relative?query=message%3A${ip}&range=86400&limit=1&fields=message&sort=desc&decorate=true&filter=streams%3A5bd804ebf13e3300018780df`
