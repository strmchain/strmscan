<template>
    ...
    <section v-else>
        <p
            v-if="total > 0"
            class="strm-total-items">{{ _nFormatNumber('order', 'orders', total) }}</p>
        <form
            v-if="showFilter"
        ...
        <div
            ...
            <p class="strm-empty__description">No order found</p>
        </div>
        <table-base
            v-if="total > 0"
            :fields="fields"
            :items="items"
            class="strm-table--lending-orders">
            <template
                slot="hash"
                slot-scope="props">
                <i
            ...
            <template
                ...
                <nuxt-link
                    v-if="props.item.lendingSymbol !== strmNativeToken"
                    :to="{name: 'tokens-slug', params: {slug: props.item.lendingToken}}">
