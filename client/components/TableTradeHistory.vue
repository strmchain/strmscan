<template>
    ...
    <section v-else>
        ...
        <p
            v-if="total > 0"
            class="strm-total-items">{{ _nFormatNumber('trade history', 'trades history', total) }}</p>
        <form
            v-if="showFilter"
        ...
        <table-base
            ...
            <template
                ...
                <span>
                    <nuxt-link
                        v-if="props.item.baseToken !== strmNativeToken"
                    ...
                    <span v-else>{{ props.item.baseSymbol }}</span>/<nuxt-link
                        v-if="props.item.quoteToken !== strmNativeToken"
