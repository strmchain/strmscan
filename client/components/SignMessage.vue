    ...
    <div class="col-12">
        <div
            ...
            <div
                ...
                <strong>
                    Method 2(easier): Using QR code scanning feature in StrmWallet to sign
                </strong>
            </div>
            <div
                v-if="error">
...
export default {
    ...
    async mounted () {
        ...
        self.messId = data.id
        // todo: change in backend aswell
        self.qrCode = encodeURI('strmchain:sign?message=' + data.message + '&' +
