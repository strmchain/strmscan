<template>
    ...
    <section v-else>
        <p
            v-if="total > 0"
            class="strm-total-items">{{ _nFormatNumber('lending topup', 'lending topups', total) }}</p>
        <form
            v-if="showFilter"
        ...
        <div
            ...
            <p class="strm-empty__description">No topup found</p>
        </div>
        <table-base
            v-if="total > 0"
            :fields="fields"
            :items="items"
            class="strm-table--lending-topup">
            <template
                slot="hash"
                slot-scope="props">
                <i
