<template>
    <section>
        <b-navbar
            ...
            variant="white"
            class="strm-nav">
            <div class="container container--wide strm-nav__wrapper">
                <b-navbar-brand :to="{name: 'index'}">
                    <img
                        src="~/assets/img/logoLight.svg"
                        alt="StrmScan"
                        class="strm-nav__logo logo-dark">
                    <img
                        src="~/assets/img/logoDark.svg"
                        alt="StrmScan"
                        class="strm-nav__logo logo-light">
                </b-navbar-brand>
                <b-navbar-toggle
                    class="strm-nav__toggle"
                    target="nav_collapse">
                    <svg
                ...
                <b-collapse
                    ...
                    <b-navbar-nav class="strm-nav__login">
                        <!-- dev cmnt:add route help when created -->
                        <b-nav-item
                            :href="'#'"
        ...
        <main
            :class="isHomePage ? 'strm-body-wrapper--home' : ''"
            class="strm-body-wrapper">
            <div class="container container--wide">
                <div
                    v-if="! isHomePage"
                    class="row align-items-center strm-body-wrapper__heading">
                    <b-col sm="4">
                        <breadcrumb/>
                    </b-col>
                    <b-col sm="8">
                ...
                <b-row v-else>
                    <b-col
                        ...
                        <div class="strm-stat d-flex">
                            <div class="strm-stat__item">
...
export default {
    ...
    mounted () {
        ...
        self.darkMode = Cookie.get('strmscan_theme') === 'dark'

        if (typeof Cookie.get('strmscan_theme') === 'undefined') {
    ...
    methods: {
        ...
        toggleDarkMode (e) {
            const darkMode = Cookie.get('strmscan_theme') !== 'dark'
            this.darkMode = darkMode

            Cookie.set('strmscan_theme', darkMode ? 'dark' : 'light', {
                expires: 365
            })
