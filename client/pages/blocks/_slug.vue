<template>
    ...
    <section v-else>
        <div class="card strm-card strm-card--block">
            <div class="strm-card__header">
                <h3
                    v-if="block"
                    class="strm-card__headline">Block
        ...
        <b-tabs
            ...
            <b-tab
                ...
                <div
                    ...
                    class="strm-empty">
                    <i class="fa fa-cube strm-empty__icon"/>
                    <p class="strm-empty__description">No slashed node</p>
                </div>
                <p
                    v-if="block.slashedNode.length > 0"
                    class="strm-total-items">{{ _nFormatNumber('node', 'nodes', block.slashedNode.length) }}</p>
                <table
                    v-if="block.slashedNode.length > 0"
                    class="strm-table">
                    <thead>
