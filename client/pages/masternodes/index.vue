<template>
    ...
    <section v-else>
        <div
            ...
            <p class="strm-empty__description">No masternode found</p>
        </div>

        <p
            v-if="total > 0"
            class="strm-total-items">{{ _nFormatNumber('MasterNode', 'MasterNodes', total) }}</p>
        ...
        <b-table
            ...
            class="strm-table strm-table--masternode"
            stacked="md">
