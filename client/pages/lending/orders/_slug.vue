<template>
    ...
    <section v-else>
        <div class="card strm-card">
            <div class="strm-card__header">
                <h3 class="strm-card__headline">
                    Hash:
                    <read-more
                        :text="hash"
                        class="d-sm-none"/>
                ...
                <table class="strm-card__table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <nuxt-link
                                    v-if="lendingOrder.lendingToken !== strmNativeToken"
                                    :to="{name: 'tokens-slug',
                        ...
                        <tr v-if="lendingOrder.side === 'BORROW'">
                            ...
                            <td>
                                <nuxt-link
                                    v-if="lendingOrder.collateralToken !== strmNativeToken"
                                    :to="{name: 'tokens-slug',
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{ lendingOrder.lendingSymbol !== strmNativeToken ?
                                    lendingOrder.lendingSymbol : 'STRM' }}
                            </td>
                        </tr>
                        <tr>
                            <td>Interest</td>
