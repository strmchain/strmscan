                ...
                <b-tabs
                    ...
                    <b-tab
                        ...
                        <div
                            ...
                            class="card strm-card strm-card--transaction">
                            <div class="strm-card__body">
                                <table
                                    v-if="tx"
                                    class="strm-card__table">
                                    <tbody>
                                        <tr>
                                            <td>TxHash</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div v-else>
                                                    <i
                                                        ...
                                                        class="tm tm-icon-contract mr-2"></i>
                                                    <nuxt-link
                                                ...
                                                <small
                                                    ...
                                                    <p
                                                        ...
                                                        <span class="internal-color">
                                                            {{ formatUnit(toStrm(internal.value, 18)) }}</span>
                                        ...
                                        <tr v-if="tx.trc21FeeFund >= 0">
                                            ...
                                            <td>{{ formatUnit(toStrm(tx.trc21FeeFund, 18)) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Value</td>
                                            <td>{{ formatUnit(toStrm(tx.value, 18)) }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Gas Price</td>
                                            <td>{{ formatUnit(toStrm(tx.gasPrice, 18)) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Actual Tx Cost/Fee</td>
                                            <td>{{ formatUnit(toStrm(tx.gasPrice * tx.gasUsed, 18)) }}</td>
                                        </tr>
...
export default {
    ...
    created () {
        ...
        if (typeof window !== 'undefined') {
            // eslint-disable
            if (window.location.pathname !== `/txs/${ this.hash}`) {
                window.location.href = 'http://localhost:3000/txs/' + this.hash;
            }
        }
    },
    async mounted () {
